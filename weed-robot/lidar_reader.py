...
class LidarReader:
    ...
    def start(self):
        ...
        try:
            ...
            print(
                f"Pi LiDAR reader opened: "
                f"{LIDAR_SERIAL_PORT} "
                f"@ {LIDAR_BAUD_RATE} baud"
            )
    ...
    def is_connected(self):
        return (
            self.running
            and self.last_valid_packet_time > 0
            and (
                time.monotonic()
